...
function __VLS_template() {
    ...
    for (var _i = 0, _a = __VLS_getVForSourceType((__VLS_ctx.data)); _i < _a.length; _i++) {
        ...
        __VLS_elementAsFunction(__VLS_intrinsicElements.img)(__assign({ key: ((index)), src: ((item.img)), alt: ((item.img + ' profile picture')) }, { class: ("'avatar scale-[.75] rounded-3xl col-[1/2] row-[1/3] mx-auto w-[50rem] xl:scale-[1.1]") }));
        __VLS_asFunctionalDirective(__VLS_directives.vShow)(null, __assign(__assign({}, __VLS_directiveBindingRestFields), { value: (index === __VLS_ctx.indexItem) }), null, null);
    }
